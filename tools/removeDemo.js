...
const pathsToRemove = [
    "./client/actions/*", "./client/utils", "./client/components/*", "./client/constants/*", "./client/containers/*",
    "./client/images", "./client/reducers/*", "./client/store/store.spec.js", "./client/styles", "./client/routes.js",
    "./client/index.js"
];
