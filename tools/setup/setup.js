...
prompt.get(prompts, function (err, result) {
    ...
    const responses = [
        {
            key: "name", value: result.projectName || "new-project"
        }, {
            key: "version", value: result.version || "0.1.0"
        }, {
            key: "author", value: result.author
        }, {
    ...
    replace({
        regex: /"keywords": \[[\s\S]+\]/, replacement: `"keywords": []`, //eslint-disable-line quotes
        paths: [ "package.json" ], recursive: false, silent: true
    });
