...
export default {
    ...
    entry: path.resolve(__dirname, "src/index"), target: "web", // necessary per https://webpack.github.io/docs/testing.html#compile-and-test
    output: {
        ...
        new HtmlWebpackPlugin({
            ...
            inject: true, // Note that you can add custom options here if you need to handle other custom logic in index.html
