...
describe("Fuel Savings Calculator", () => {
    describe("necessaryDataIsProvidedToCalculateSavings", () => {
        ...
        it("returns true when necessary data is provided", () => {
            // arrange
            const settings = {
                newMpg: 20, tradeMpg: 10, newPpg: 1.50, tradePpg: 1.50, milesDriven: 100
            };
    ...
    describe("calculateSavingsPerMonth", () => {
        it("returns 29.93 in savings per month with these settings", () => {
            // arrange
            const settings = {
                tradePpg: 3.75, tradeMpg: 24, newPpg: 3.75, newMpg: 38, milesDriven: 120, milesDrivenTimeframe: "week"
            };
        ...
        it("returns 40.83 in savings per month with these settings", () => {
            // arrange
            const settings = {
                tradePpg: 4.15, tradeMpg: 24, newPpg: 3.75, newMpg: 38, milesDriven: 550, milesDrivenTimeframe: "month"
            };
        ...
        it("returns -157.12 in loss per month with these settings", () => {
            // arrange
            const settings = {
                tradePpg: 3.15, tradeMpg: 40, newPpg: 3.75, newMpg: 18, milesDriven: 14550, milesDrivenTimeframe: "year"
            };
